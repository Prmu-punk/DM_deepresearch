...
async def kg_enhance(state: ResearcherState, config: RunnableConfig):
    """Knowledge Graph enhancement node that enriches research context.
    
    This node queries ConceptNet to find related concepts for the research topic
    and adds this context to the researcher's state.
    
    Args:
        state: Current researcher state with research topic
        config: Runtime configuration with KG enhancement settings
...
""")
            return {
                ...
                "researcher_messages": [kg_message]
            }
    
    except Exception as e:
        # Log error but don't fail the workflow
        import logging
        logging.warning(f"KG enhancement failed: {e}")
...
researcher_builder.add_node("kg_enhance", kg_enhance)                 # KG enhancement (NEW!)
researcher_builder.add_node("researcher", researcher)                 # Main researcher logic
researcher_builder.add_node("researcher_tools", researcher_tools)     # Tool execution handler
researcher_builder.add_node("compress_research", compress_research)   # Research compression

# Define researcher workflow edges
researcher_builder.add_edge(START, "kg_enhance")           # Entry point to KG enhancement
researcher_builder.add_edge("kg_enhance", "researcher")    # KG to researcher
