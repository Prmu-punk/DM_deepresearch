...
async def get_all_tools(config: RunnableConfig):
    ...
    # Check if KG enhancement is enabled for Tavily search
    use_kg = getattr(configurable, 'use_kg_enhancement', False)
    
    if use_kg and search_api == SearchAPI.TAVILY:
        # Use KG-enhanced Tavily search
        from open_deep_research.kg_enhanced_search import kg_enhanced_tavily_search
        tools.append(kg_enhanced_tavily_search)
    else:
